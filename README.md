...
`ember-cli 4.9.2 + node 18.12.1/19.3.0 + npm 8.19.2/9.2.0 + bower 1.8.8 + yarn 1.22.19/1.22.19 + chrome 108.0.5359.124 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`4.9.2`,`4.9.2-node_18.12`,`latest` (4.9.2/Dockerfile)](https://github.com/danlynn/ember-cli/blob/4.9.2/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.9.2` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.9.2 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.9.2 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.9.2 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.9.2
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.9.2 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:4.9.2
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.9.2 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.9.2 bash
```
