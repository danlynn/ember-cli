...
+ [`3.8.1`,`3.8.1-node_10.15`,`latest` (3.8.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.8.1/Dockerfile)
...
`ember-cli 3.8.1 + node 10.15.2/11.10.1 + npm 6.4.1/6.5.0-next.0 + bower 1.8.4 + yarn 1.13.0 + chrome 72.0.3626.119 + watchman 4.9.0`
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.8.1
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.8.1 ember test
```
