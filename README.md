...
+ [`2.5.1`,`latest` (2.5.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/2.5.1/Dockerfile)
...
ember-cli v2.5.1 + node 4.2.3 + npm 2.14.7 + bower 1.7.1 + phantomjs 1.9.19 + watchman 3.5.0
...
3. Start the ember server:
   ...
   ```
   $ docker run --rm --privileged --entrypoint sysctl danlynn/ember-cli:2.5.1 -w fs.inotify.max_user_watches=524288
   ```
