...
`ember-cli 3.26.1 + node 14.16.1/15.14.0 + npm 6.14.12/7.7.6 + bower 1.8.8 + yarn 1.22.5/1.22.5 + chrome 90.0.4430.85 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`3.26.1`,`3.26.1-node_14.16`,`latest` (3.26.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.26.1/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.26.1` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.26.1 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.26.1 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.26.1 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.26.1
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.26.1 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.26.1
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.26.1 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.26.1 bash
```
