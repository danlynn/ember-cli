...
`ember-cli 5.5.0 + node 20.10.0/21.4.0 + npm 10.2.3/10.2.4 + bower 1.8.8 + yarn 1.22.19/1.22.19 + chrome 120.0.6099.109 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`5.5.0`,`5.5.0-node_20.10`,`latest` (5.5.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/5.5.0/Dockerfile)
+ [`5.5.0-node_21.2` (5.5.0-node_21.2/Dockerfile)](https://github.com/danlynn/ember-cli/blob/5.5.0-node_21.2/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.5.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.5.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.5.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.5.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.5.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.5.0 bash
