...
`ember-cli 3.28.5 + node 16.13.1 + npm 8.1.2 + bower 1.8.8 + yarn 1.22.15 + chrome 96.0.4664.110 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`3.28.5`,`3.28.5-node_16.13`,`latest` (3.28.5/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.28.5/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.5` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.5 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.5 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.5 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.28.5
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.28.5 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.28.5
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.28.5 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.28.5 bash
```
