...
`ember-cli 5.0.0 + node 18.16.1/20.3.1 + npm 9.5.1/9.6.7 + bower 1.8.8 + yarn 1.22.19/1.22.19 + chrome 114.0.5735.198 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`5.0.0`,`5.0.0-node_18.16`,`latest` (5.0.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/5.0.0/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.12.1` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.12.1 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.12.1 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.12.1 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.12.1
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.12.1 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:4.12.1
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.12.1 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.12.1 bash
```
