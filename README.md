...
`ember-cli 4.2.0 + node 16.14.0/17.6.0 + npm 8.3.1/8.5.1 + bower 1.8.8 + yarn 1.22.17/1.22.17 + chrome 98.0.4758.102 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`4.2.0`,`4.2.0-node_16.14`,`latest` (4.2.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/4.2.0/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.2.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.2.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.2.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.2.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.2.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.2.0 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:4.2.0
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.2.0 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.2.0 bash
```
