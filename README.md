...
`ember-cli 5.1.0 + node 18.17.0/20.5.0 + npm 9.6.7/9.8.0 + bower 1.8.8 + yarn 1.22.19/1.22.19 + chrome 115.0.5790.102 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`5.1.0`,`5.1.0-node_18.17`,`latest` (5.1.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/5.1.0/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.1.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.1.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.1.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.1.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.1.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.1.0 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:5.1.0
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:5.1.0 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:5.1.0 bash
```
