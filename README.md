...
`ember-cli 3.28.2 + node 14.18.1/16.11.1 + npm 6.14.15/8.0.0 + bower 1.8.8 + yarn 1.22.15/1.22.15 + chrome 94.0.4606.81 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`3.28.2`,`3.28.2-node_14.18`,`latest` (3.28.2/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.28.2/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.2` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.2 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.2 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.28.2 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.28.2
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.28.2 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.28.2
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.28.2 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.28.2 bash
```
