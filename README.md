...
+ [`3.4.2`,`3.4.2-node_8.12`,`latest` (3.4.2/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.4.2/Dockerfile)
+ [`3.4.2-node_10.10` (3.4.2-node_10.10/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.4.2-node_10.10/Dockerfile)
+ [`3.4.1`,`3.4.1-node_8.11` (3.4.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.4.1/Dockerfile)
+ [`3.4.1-node_10.10` (3.4.1-node_10.10/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.4.1-node_10.10/Dockerfile)
...
`ember-cli 3.4.2 + node 8.12.0/10.10.0 + npm 6.4.1 + bower 1.8.4 + yarn 1.9.4 + chrome 69.0.3497.100 + watchman 4.9.0` 
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.4.2
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.4.2 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.4.2 bash
```
...
3. Start the ember server:
   ...
   ```
   $ docker run --rm --privileged danlynn/ember-cli:3.4.2 sysctl -w fs.inotify.max_user_watches=524288
   ```
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.4.2` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.4.2 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.4.2 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.4.2 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.4.2
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.4.2 bash
