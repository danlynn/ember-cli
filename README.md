...
+ [`3.1.3`,`3.1.3-node_8.11`,`latest` (3.1.3/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.1.3/Dockerfile)
+ [`3.1.3-node_9.11` (3.1.3-node_9.11/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.1.3-node_9.11/Dockerfile)
...
`ember-cli 3.1.3 + node 8.11.1/10.0.0 + npm 5.6.0/5.6.0 + bower 1.8.4 + yarn 1.5.1 + chrome 65.0.3325.181 + watchman 4.9.0`
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.1.3
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.1.3 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.1.3 bash
```
...
3. Start the ember server:
   ...
   ```
   $ docker run --rm --privileged danlynn/ember-cli:3.1.3 sysctl -w fs.inotify.max_user_watches=524288
   ```
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.1.3` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.1.3 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.1.3 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.1.3 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.1.3
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.1.3 bash
