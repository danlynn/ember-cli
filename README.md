...
`ember-cli 3.11.0 + node 10.16.0/12.6.0 + npm 6.9.0 + bower 1.8.8 + yarn 1.16.0 + chrome 75.0.3770.142 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`3.11.0`,`3.11.0-node_10.16`,`latest` (3.11.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.11.0/Dockerfile)
+ [`3.11.0-node_12.6` (3.11.0-node_12.3/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.11.0-node_12.3/Dockerfile)
...
+ [`3.8.1`,`3.8.1-node_10.15` (3.8.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.8.1/Dockerfile)
+ [`3.8.1-node_11.10` (3.8.1-node_11.10/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.8.1-node_11.10/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.11.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.11.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.11.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.11.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.11.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.11.0 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.11.0
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.11.0 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.11.0 bash
```
