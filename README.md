...
`ember-cli 6.4.0 + node 22.15.0/23.11.0 + npm 10.9.2/10.9.2 + bower 1.8.8 + yarn 1.22.22/1.22.22 + chrome 136.0.7103.59 + watchman 4.9.0`

### Supported tags and respective `Dockerfile` links

+ [`6.4.0`,`6.4.0-node_22.15`,`latest` (6.4.0/Dockerfile)](https://github.com/danlynn/ember-cli/blob/6.4.0/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:6.4.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:6.4.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:6.4.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:6.4.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:6.4.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:6.4.0 bash
