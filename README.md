...
`ember-cli 3.15.1 + node 12.14.0/13.5.0 + npm 6.13.4/6.13.4 + bower 1.8.8 + yarn 1.21.1 + chrome 79.0.3945.88 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`3.15.1`,`3.15.1-node_12.14`,`latest` (3.15.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/3.15.1/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.15.1` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.15.1 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.15.1 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:3.15.1 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.15.1
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:3.15.1 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:3.15.1
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.15.1 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:3.15.1 bash
```
