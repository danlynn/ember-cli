...
`ember-cli 4.1.1 + node 16.13.2/17.4.0 + npm 8.1.2/8.3.1 + bower 1.8.8 + yarn 1.22.15/1.22.17 + chrome 97.0.4692.99 + watchman 4.9.0`


### Supported tags and respective `Dockerfile` links

+ [`4.1.1`,`4.1.1-node_16.13`,`latest` (4.1.1/Dockerfile)](https://github.com/danlynn/ember-cli/blob/4.1.1/Dockerfile)
+ [`4.1.1-node_17.4` (4.1.1-node_17.4/Dockerfile)](https://github.com/danlynn/ember-cli/blob/4.1.1-node_17.4/Dockerfile)
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.1.1` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.1.1 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.1.1 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:4.1.1 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.1.1
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:4.1.1 bash
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 danlynn/ember-cli:4.1.1
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.1.1 ember test
```
...
NEW: $ docker run -ti --rm -v $(pwd):/myapp danlynn/ember-cli:4.1.1 bash
```
