...
`ember-cli 5.9.0 + node 20.14.0/22.2.0 + npm 10.7.0/10.7.0 + bower 1.8.8 + yarn 1.22.22/1.22.19 + chrome 126.0.6478.55 + watchman 4.9.0`
...
Basically put `docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.9.0` before any command you run.

Example:

```
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.9.0 npm install
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.9.0 bower --allow-root install bootstrap
$ docker run --rm -ti -v $(pwd):/myapp danlynn/ember-cli:5.9.0 ember generate model user
$ docker run --rm -ti -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.9.0
```
...
$ mkdir new_ember_app
$ cd new_ember_app
$ docker run --rm -it -v $(pwd):/myapp -p 4200:4200 -p 7020:7020 -p 7357:7357 danlynn/ember-cli:5.9.0 bash
